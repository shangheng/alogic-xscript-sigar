...
public class Demo {
	...
	public static void main(String[] args) {
		...
		run("java:///xscript/CPU.xml#Demo",settings);
		run("java:///xscript/CPUInfo.xml#Demo",settings);
		run("java:///xscript/OS.xml#Demo",settings);
		run("java:///xscript/FileSystem.xml#Demo",settings);
		run("java:///xscript/Info.xml#Demo",settings);
		run("java:///xscript/Mem.xml#Demo",settings);
		run("java:///xscript/NetInfo.xml#Demo",settings);
		run("java:///xscript/NetStat.xml#Demo",settings);
		run("java:///xscript/Process.xml#Demo",settings);
	}
}
