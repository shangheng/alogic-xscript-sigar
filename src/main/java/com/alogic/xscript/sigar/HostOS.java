 ...
 *
 */
public class HostOS extends SigarOperation {

	public HostOS(String tag, Logiclet p) {
		super(tag, p);
	}
	...
	@Override
	protected void onExecute(HostTools hostTool, Map<String, Object> root, Map<String, Object> current,
